...
describe('Price Calculator Unit Tests', () => {
  ...
  describe('Discount Code Application', () => {
    ...
    it('should not apply discount for an invalid discount code', () => {
      const details = {
        baseFare: 100,
        numberOfPassengers: 1,
        isInternational: false,
  ...
  describe('Insurance Costs', () => {
    it('should add insurance cost if hasInsurance is true', () => {
      ...
      // Expected: (Base Fare * 1.0) + Domestic Tax (12%) + Insurance (30) = 112 + 30 = 142
      const basePlusClass = 100 * 1.0;
      const basePlusClassPlusTax = basePlusClass + (basePlusClass * 0.12);
      const expectedPrice = basePlusClassPlusTax + (30 * details.numberOfPassengers);
      expect(calculateFinalPrice(details)).to.equal(parseFloat(expectedPrice.toFixed(2)));
    });
    ...
    it('should add insurance cost for multiple passengers if hasInsurance is true', () => {
      ...
      // Expected: (Base Fare * 1.0 * Passengers) + Domestic Tax (12%) + Insurance (30 * Passengers)
      // (100 * 1 * 2) + (200 * 0.12) + (30 * 2) = 200 + 24 + 60 = 284
